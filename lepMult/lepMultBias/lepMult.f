...
C
          integer i
          double precision  lepMult
C          double precision ptj(nexternal)
C          double precision max_ptj
c
...
c$$$          bias_weight = DLOG10(lepMult)
          bias_weight = 2**lepMult
